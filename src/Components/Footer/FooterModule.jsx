    ...
    <>
      <div className="footer-column">
        ...
        <ul>
          ...
          <li>
            <a href="#">{t("HealthSafety")}</a>
          </li>
          <li>
            <a href="#">{t("Destinations Covered")}</a>
          </li>
        </ul>
      </div>
    </>
    ...
    <div className="footer-column">
      ...
      <ul>
        ...
        <li>
          ...
          <a href="mailto:sales@coachhire4u.com">
            {t("Email")}: sales@coachhire4u.com
          </a>
        </li>
      </ul>
    </div>
