  ...
  return (
    <NavDropdown title={t("Area")} id="area">
      <Link to="/LondonCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("London Coach Hire")}</NavDropdown.Item>
        <Link to="/EnglandCoachHire" className="dropdown-link"></Link>
        <NavDropdown.Item as="div">{t("England Coach Hire")}</NavDropdown.Item>
      </Link>
      <Link to="/IrelandCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("Ireland Coach Hire")}</NavDropdown.Item>
      </Link>
      <Link to="/ScotlandCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("Scotland Coach Hire")}</NavDropdown.Item>
      </Link>
      <Link to="/WalesCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("Wales Coach Hire")}</NavDropdown.Item>
      </Link>
      <Link to="/EuropeanCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("European Coach Hire")}</NavDropdown.Item>
      </Link>
    </NavDropdown>
  );
};
  ...
  return (
    <NavDropdown title={t("Service")} id="service">
      <Link to="/AirportTransfers" className="dropdown-link">
        <NavDropdown.Item as="div">{t("Airport Transfer")}</NavDropdown.Item>
      </Link>
      <Link to="/EventsFestivals" className="dropdown-link">
        <NavDropdown.Item as="div">{t("EventFestival")}</NavDropdown.Item>
      </Link>
  ...
  return (
    <NavDropdown title={t("Fleet")} id="fleet">
      <Link to="/SeatMiniBux1619" className="dropdown-link">
        <NavDropdown.Item as="div">16-19 {t("Mini Bus")}</NavDropdown.Item>
      </Link>
      <Link to="/SeatCoach2034" className="dropdown-link">
        <NavDropdown.Item as="div">20-34 {t("Seat Coach")}</NavDropdown.Item>
      </Link>
      <Link to="/SeatCoach5053" className="dropdown-link">
        <NavDropdown.Item as="div">50-53 {t("Seat Coach")}</NavDropdown.Item>
      </Link>
      <Link to="/SeatCoach5361" className="dropdown-link">
        <NavDropdown.Item as="div">53-61 {t("Seat Coach")}</NavDropdown.Item>
      </Link>
      <Link to="/SeatCoach7074" className="dropdown-link">
        <NavDropdown.Item as="div">70-74 {t("Seat Coach")}</NavDropdown.Item>
      </Link>
      <Link to="/CheapCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("Cheap Coach Hire")}</NavDropdown.Item>
      </Link>
    </NavDropdown>
  );
};
  ...
  return (
    <NavDropdown title={t("Things To Do")} id="thingstodo">
      <Link to="/FestivalCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("Festival Coach Hire")}</NavDropdown.Item>
      </Link>
      ...
      <Link to="/UKToursCoachHire" className="dropdown-link">
        <NavDropdown.Item as="div">{t("UK Tours Coach Hire")}</NavDropdown.Item>
      </Link>
    </NavDropdown>
  );
};
